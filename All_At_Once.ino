...
int runs = 10;       // total amount of times to display light array
...
void loop() {
  if (runs > 0) {
    runs --;
    delay(random(500)+50);                    //delays LED light up
...
//  Serial.println(num_correct+num_incorrect);
//  Serial.print("   Correct hits = ");
//  Serial.println(num_correct);
//  Serial.print("   Incorrect hits = ");
//  Serial.println(num_incorrect);
//  Serial.println("");
//}
...
bool end_func() {
  ...
  Serial.print("   Average reaction time = "); Serial.print(float(float(total_rxn_time)/float(tot_run))/1000); Serial.println(" s");
  Serial.print("   Total hits = "); Serial.println(total_incorrect + total_correct);
  Serial.print("   Accuracy = "); Serial.print((float(total_correct)/float(total_incorrect + total_correct))*100); Serial.println("%");
//  Serial.print("      Correct = "); Serial.println(total_correct);
//  Serial.print("      Incorrect = "); Serial.println(total_incorrect);
  
  while(digitalRead(buttons[14]) == HIGH);
  runs = tot_run; total_rxn_time = 0; total_incorrect = 0; total_correct = 0;
